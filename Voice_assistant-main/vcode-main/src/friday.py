...
def respond(voice_data):
    ...
    if is_awake==False:
        ...
        reply('My name is friday i am build by Rakesh!')
    
    elif 'i love you' in voice_data:
        reply('I too love you Rakesh!')
        ...
        try:
            ...
            reply('This is what I found Rakesh')
        except:
            reply('Please check your Internet')

    elif 'explain' in voice_data:
        reply("don't warry Rakesh, I will explain for you!")
        ...
        reply("Good bye Rakesh! Have a nice day.")
        is_awake = False
